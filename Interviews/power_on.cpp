...
int main()
{
	...
	mac[0] = 0x88; // 1st octet of the MAC Address
	mac[1] = 0xb4; // 2nd octet of the MAC Address
	mac[2] = 0xa6; // 3rd octet of the MAC Address
	mac[3] = 0x1b; // 4th octet of the MAC Address
	mac[4] = 0xde; // 5th octet of the MAC Address
	mac[5] = 0x6d; // 6th octet of the MAC Address
